 ...
 * @author rescorsim
 */
public class Fractify implements IStrategy{
    ...
    public int defaultTakeProfit = 150;
    ...
    public static Instrument defaultInstrument = Instrument.GBPUSD;
    ...
    public static void main(String[] args) throws Exception {
        MenuStrategy menuStrategy = new MenuStrategy(new Fractify(), defaultInstrument);
    ...
    public void onBar(Instrument instrument, Period period, IBar askBar, IBar bidBar) throws JFException {
        ...
        try {
            double[] values = context.getIndicators().fractal(
                    defaultInstrument, defaultPeriod, OfferSide.BID, 30, 0);
            for(int i = 0; values[i] != 0; i++){
                if(!Double.isNaN(values[i])){
                    console.getOut().println("Fractify -> values["+i+"] = "+values[i]);
                }
            }
            values = context.getIndicators().fractal(
                    defaultInstrument, defaultPeriod, OfferSide.BID, 30, 1);
            for(int i = 0; values[i] != 0; i++){
                if(!Double.isNaN(values[i])){
                    console.getOut().println("Fractify -> values["+i+"] = "+values[i]);
                }
            ...
            values = context.getIndicators().fractal(
                    defaultInstrument, defaultPeriod, OfferSide.BID, 30, 2);
            for(int i = 0; values[i] != 0; i++){
                if(!Double.isNaN(values[i])){
                    console.getOut().println("Fractify -> values["+i+"] = "+values[i]);
                }
            ...
            values = context.getIndicators().fractal(
                    defaultInstrument, defaultPeriod, OfferSide.BID, 30, 16);
            for(int i = 0; values[i] != 0; i++){
                if(!Double.isNaN(values[i])){
                    console.getOut().println("Fractify -> values["+i+"] = "+values[i]);
                }
            ...
            values = context.getIndicators().fractal(
                    defaultInstrument, defaultPeriod, OfferSide.BID, 30, 14);
            for(int i = 0; values[i] != 0; i++){
                if(!Double.isNaN(values[i])){
                    console.getOut().println("Fractify -> values["+i+"] = "+values[i]);
                }
                        ...
                        values = context.getIndicators().fractal(
                    defaultInstrument, defaultPeriod, OfferSide.BID, 30, 29);
            for(int i = 0; values[i] != 0; i++){
                if(!Double.isNaN(values[i])){
                    console.getOut().println("Fractify -> values["+i+"] = "+values[i]);
                }
            ...
            values = context.getIndicators().fractal(
                    defaultInstrument, defaultPeriod, OfferSide.BID, 30, 30);
            for(int i = 0; values[i] != 0; i++){
                if(!Double.isNaN(values[i])){
                    console.getOut().println("Fractify -> values["+i+"] = "+values[i]);
                }
            ...
            values = context.getIndicators().fractal(
                    defaultInstrument, defaultPeriod, OfferSide.BID, 30, 31);
            for(int i = 0; values[i] != 0; i++){
                if(!Double.isNaN(values[i])){
                    console.getOut().println("Fractify -> values["+i+"] = "+values[i]);
                }
