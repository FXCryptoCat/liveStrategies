 ...
 * @author rescorsim
 */
public class AngelTema  implements IStrategy{
    ...
    //public 
    public int anglePeriod = 9;
    public double angleLimitOpen1 = 0.01;
    public double angleLimitOpen2 = 0.02;
    public double angleLimitOpen3 = 0.03;
    public double angleLimitClose = 0.004;
    ...
    public static void main(String[] args) throws Exception {
        MenuStrategy menuStrategy = new MenuStrategy(new AngelTema());
    ...
    public void onBar(Instrument instrument, Period period, IBar askBar, IBar bidBar) throws JFException {
        ...
        try {
            double[] valuesAngle = context.getIndicators().linearRegAngle(
                    defaultInstrument, defaultPeriod, OfferSide.BID, IIndicators.AppliedPrice.CLOSE, 
                    anglePeriod, Filter.WEEKENDS, 3, bidBar.getTime(), 0);
           

            console.getOut().println("NewBar-> valuesAngle[0]:" + valuesAngle[0]+
                    ", valuesAngle[1]: "+valuesAngle[1]+
                    ", valuesAngle[2]: "+valuesAngle[2]
                );
            
            if(valuesAngle[1] < angleLimitOpen1 && valuesAngle[2] >= angleLimitOpen1 || 
                    valuesAngle[1] < angleLimitOpen2 && valuesAngle[2] >= angleLimitOpen2 || 
                    valuesAngle[1] < angleLimitOpen3 && valuesAngle[2] >= angleLimitOpen3){ // BUY OPEN
            ...
            else if(valuesAngle[1] >= angleLimitClose && valuesAngle[2] < angleLimitClose){ // BUY CLOSE
            ...
            else if(valuesAngle[1] > -angleLimitOpen1 && valuesAngle[2] <= -angleLimitOpen1 || 
                    valuesAngle[1] > -angleLimitOpen2 && valuesAngle[2] <= -angleLimitOpen2 ||
                    valuesAngle[1] > -angleLimitOpen3 && valuesAngle[2] <= -angleLimitOpen3){ // SELL OPEN
            ...
            else if(valuesAngle[1] <= -angleLimitClose && valuesAngle[2] > -angleLimitClose){ // SELL CLOSE
