 ...
 * @author rescorsim
 */
public class TemaRsi  implements IStrategy{
    ...
    public static void main(String[] args) throws Exception {
        MenuStrategy menuStrategy = new MenuStrategy(new TemaRsi());
    ...
    public void onBar(Instrument instrument, Period period, IBar askBar, IBar bidBar) throws JFException {
        ...
        try {
            double[] valuesT3 = context.getIndicators().tema(
                    defaultInstrument, defaultPeriod, OfferSide.BID, IIndicators.AppliedPrice.CLOSE, 
                    temaPeriod, Filter.WEEKENDS, 3, bidBar.getTime(), 0);
            
            double[] valuesDonChin = context.getIndicators().rsi( 
                    defaultInstrument, defaultPeriod, OfferSide.BID, IIndicators.AppliedPrice.CLOSE, 
                    rsiPeriod, Filter.WEEKENDS, periodCheckRsi, bidBar.getTime(), 0);
