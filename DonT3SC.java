 ...
 * @author rescorsim
 */
public class DonT3SC  implements IStrategy{
    ...
    public int defaultTakeProfit = 160;
    //@Configurable("defaultStopLoss:")
    public int defaultStopLoss = 50;
    //@Configurable("defaultInstrument:")
    public Instrument defaultInstrument = Instrument.USDJPY;
    ...
    //public 
    public int t3Period = 9;
    public double vfactor = 0.7;
    public int donchianPeriod = 40;
    public int maxVolatilityPips = 50;
    public int minVolatilityPips = 30;
    ...
    public static void main(String[] args) throws Exception {
        MenuStrategy menuStrategy = new MenuStrategy(new DonT3SC());
    ...
    public void onBar(Instrument instrument, Period period, IBar askBar, IBar bidBar) throws JFException {
        ...
        try {
            ...
            double[][] valuesDonChin = context.getIndicators().donchian(
                    ...
                    this.donchianPeriod, Filter.WEEKENDS, 1, bidBar.getTime(), 0);
            
                        
            //double currentVolatilityInPips = valuesDonChin[0][1] - valuesDonChin[1][1];  
            double currentVolatilityInPips = valuesDonChin[0][0] - valuesDonChin[1][0];  
            boolean isMinVolatility = currentVolatilityInPips >= (minVolatilityPips*defaultInstrument.getPipValue()); 
            boolean isMaxVolatility = currentVolatilityInPips <= (maxVolatilityPips*defaultInstrument.getPipValue()); 
